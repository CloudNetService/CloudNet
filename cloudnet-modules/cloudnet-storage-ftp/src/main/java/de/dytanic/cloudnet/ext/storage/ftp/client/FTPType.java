...
public enum FTPType {
    ...
    private BiFunction<String, FTPCredentials, GeneralFTPStorage> storageProvider;

    FTPType(BiFunction<String, FTPCredentials, GeneralFTPStorage> storageProvider) {
        this.storageProvider = storageProvider;
    }

    public GeneralFTPStorage createNewTemplateStorage(String storage, FTPCredentials credentials) {
