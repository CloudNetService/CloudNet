...
/**
 * Use {@link de.dytanic.cloudnet.driver.event.events.service.CloudServiceDisconnectNetworkEvent} instead with the
 * {@link de.dytanic.cloudnet.driver.event.EventListener} annotation and register it using {@link
