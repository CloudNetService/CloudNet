...
public final class BukkitCloudNetListener {
  ...
  public void handle(ServiceInfoSnapshotConfigureEvent event) {
    ...
    this.bukkitCall(new BukkitServiceInfoSnapshotConfigureEvent(
  ...
  public void handle(CloudServiceInfoUpdateEvent event) {
    this.bukkitCall(
      new BukkitCloudServiceInfoUpdateEvent(event.getServiceInfo()));
  }

  @EventListener
  public void handle(CloudServiceRegisterEvent event) {
    this.bukkitCall(
      new BukkitCloudServiceRegisterEvent(event.getServiceInfo()));
  }
  ...
  public void handle(CloudServiceConnectNetworkEvent event) {
    this.bukkitCall(
      new BukkitCloudServiceConnectNetworkEvent(event.getServiceInfo()));
  }

  @EventListener
  public void handle(CloudServiceDisconnectNetworkEvent event) {
    this.bukkitCall(
      new BukkitCloudServiceDisconnectNetworkEvent(event.getServiceInfo()));
  }
  ...
  public void handle(CloudServiceUnregisterEvent event) {
    this.bukkitCall(
      new BukkitCloudServiceUnregisterEvent(event.getServiceInfo()));
  }

  @EventListener
  public void handle(ChannelMessageReceiveEvent event) {
    this.bukkitCall(new BukkitChannelMessageReceiveEvent(event.getChannel(),
  ...
  public void handle(NetworkClusterNodeInfoUpdateEvent event) {
    this.bukkitCall(new BukkitNetworkClusterNodeInfoUpdateEvent(
  ...
  public void handle(NetworkChannelPacketReceiveEvent event) {
    this.bukkitCall(
      new BukkitNetworkChannelPacketReceiveEvent(event.getChannel(),
        event.getPacket()));
  }

  @EventListener
  public void handle(BridgeConfigurationUpdateEvent event) {
    this.bukkitCall(new BukkitBridgeConfigurationUpdateEvent(
      event.getBridgeConfiguration()));
  }

  @EventListener
  public void handle(BridgeProxyPlayerLoginRequestEvent event) {
    this.bukkitCall(new BukkitBridgeProxyPlayerLoginSuccessEvent(
  ...
  public void handle(BridgeProxyPlayerServerConnectRequestEvent event) {
    this.bukkitCall(new BukkitBridgeProxyPlayerServerConnectRequestEvent(
      event.getNetworkConnectionInfo(), event.getNetworkServiceInfo()));
  }

  @EventListener
  public void handle(BridgeProxyPlayerServerSwitchEvent event) {
    this.bukkitCall(new BukkitBridgeProxyPlayerServerSwitchEvent(
      event.getNetworkConnectionInfo(), event.getNetworkServiceInfo()));
  }

  @EventListener
  public void handle(BridgeProxyPlayerDisconnectEvent event) {
    this.bukkitCall(new BukkitBridgeProxyPlayerDisconnectEvent(
      event.getNetworkConnectionInfo()));
  }

  @EventListener
  public void handle(BridgeServerPlayerLoginRequestEvent event) {
    this.bukkitCall(new BukkitBridgeServerPlayerLoginRequestEvent(
  ...
  public void handle(BridgeServerPlayerLoginSuccessEvent event) {
    this.bukkitCall(new BukkitBridgeServerPlayerLoginSuccessEvent(
      event.getNetworkConnectionInfo(), event.getNetworkPlayerServerInfo()));
  }

  @EventListener
  public void handle(BridgeServerPlayerDisconnectEvent event) {
    this.bukkitCall(new BukkitBridgeServerPlayerDisconnectEvent(
      event.getNetworkConnectionInfo(), event.getNetworkPlayerServerInfo()));
  }

  private void bukkitCall(Event event) {
    Bukkit.getScheduler()
      .runTask(BukkitCloudNetHelper.getPlugin(), new Runnable() {
        @Override
        public void run() {
