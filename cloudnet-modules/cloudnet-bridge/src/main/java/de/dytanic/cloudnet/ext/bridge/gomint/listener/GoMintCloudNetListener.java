...
public final class GoMintCloudNetListener {
  ...
  public void handle(ServiceInfoSnapshotConfigureEvent event) {
    ...
    this.goMintCall(new GoMintServiceInfoSnapshotConfigureEvent(
  ...
  public void handle(CloudServiceInfoUpdateEvent event) {
    this.goMintCall(
        new GoMintCloudServiceInfoUpdateEvent(event.getServiceInfo()));
  }

  @EventListener
  public void handle(CloudServiceRegisterEvent event) {
    this.goMintCall(
        new GoMintCloudServiceRegisterEvent(event.getServiceInfo()));
  }
  ...
  public void handle(CloudServiceConnectNetworkEvent event) {
    this.goMintCall(
        new GoMintCloudServiceConnectNetworkEvent(event.getServiceInfo()));
  }

  @EventListener
  public void handle(CloudServiceDisconnectNetworkEvent event) {
    this.goMintCall(
        new GoMintCloudServiceDisconnectNetworkEvent(event.getServiceInfo()));
  }
  ...
  public void handle(CloudServiceUnregisterEvent event) {
    this.goMintCall(
        new GoMintCloudServiceUnregisterEvent(event.getServiceInfo()));
  }

  @EventListener
  public void handle(ChannelMessageReceiveEvent event) {
    this.goMintCall(new GoMintChannelMessageReceiveEvent(event.getChannel(),
  ...
  public void handle(NetworkClusterNodeInfoUpdateEvent event) {
    this.goMintCall(new GoMintNetworkClusterNodeInfoUpdateEvent(
  ...
  public void handle(NetworkChannelPacketReceiveEvent event) {
    this.goMintCall(
        new GoMintNetworkChannelPacketReceiveEvent(event.getChannel(),
            event.getPacket()));
  }

  @EventListener
  public void handle(BridgeConfigurationUpdateEvent event) {
    this.goMintCall(new GoMintBridgeConfigurationUpdateEvent(
        event.getBridgeConfiguration()));
  }

  @EventListener
  public void handle(BridgeProxyPlayerLoginRequestEvent event) {
    this.goMintCall(new GoMintBridgeProxyPlayerLoginSuccessEvent(
  ...
  public void handle(BridgeProxyPlayerServerConnectRequestEvent event) {
    this.goMintCall(new GoMintBridgeProxyPlayerServerConnectRequestEvent(
        event.getNetworkConnectionInfo(), event.getNetworkServiceInfo()));
  }

  @EventListener
  public void handle(BridgeProxyPlayerServerSwitchEvent event) {
    this.goMintCall(new GoMintBridgeProxyPlayerServerSwitchEvent(
        event.getNetworkConnectionInfo(), event.getNetworkServiceInfo()));
  }

  @EventListener
  public void handle(BridgeProxyPlayerDisconnectEvent event) {
    this.goMintCall(new GoMintBridgeProxyPlayerDisconnectEvent(
        event.getNetworkConnectionInfo()));
  }

  @EventListener
  public void handle(BridgeServerPlayerLoginRequestEvent event) {
    this.goMintCall(new GoMintBridgeServerPlayerLoginRequestEvent(
  ...
  public void handle(BridgeServerPlayerLoginSuccessEvent event) {
    this.goMintCall(new GoMintBridgeServerPlayerLoginSuccessEvent(
        event.getNetworkConnectionInfo(), event.getNetworkPlayerServerInfo()));
  }

  @EventListener
  public void handle(BridgeServerPlayerDisconnectEvent event) {
    this.goMintCall(new GoMintBridgeServerPlayerDisconnectEvent(
        event.getNetworkConnectionInfo(), event.getNetworkPlayerServerInfo()));
  }
