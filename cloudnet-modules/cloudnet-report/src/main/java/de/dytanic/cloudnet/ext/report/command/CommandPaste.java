                ...
                SubCommandBuilder.create()
                        ...
                        .generateCommand(
                                (subCommand, sender, command, args, commandLine, properties, internalProperties) -> {
                                    ServiceInfoSnapshot serviceInfoSnapshot = CloudNet.getInstance().getCloudServiceProvider().getCloudServiceByName((String) args.argument("name").get());
                                    internalProperties.put("content", CloudNetReportModule.getInstance().createPasteContentService(serviceInfoSnapshot));
                                },
