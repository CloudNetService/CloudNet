...
public class SignConfigurationEntry implements SerializableObject, Cloneable {
    ...
    public static @NotNull SignConfigurationEntry createDefault(String targetGroup, String onlineBlockType, String fullBlockType, String startingBlock, String searchingBlock) {
