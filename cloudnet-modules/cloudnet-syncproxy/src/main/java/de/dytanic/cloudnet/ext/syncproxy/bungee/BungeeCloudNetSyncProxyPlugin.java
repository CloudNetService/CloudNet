...
public final class BungeeCloudNetSyncProxyPlugin extends Plugin {
    ...
    public void onEnable() {
        AbstractSyncProxyManagement syncProxyManagement = new BungeeSyncProxyManagement(this);
        ...
        ProxyServer.getInstance().getPluginManager().registerListener(this, new BungeeProxyLoginConfigurationImplListener(syncProxyManagement));
    }
