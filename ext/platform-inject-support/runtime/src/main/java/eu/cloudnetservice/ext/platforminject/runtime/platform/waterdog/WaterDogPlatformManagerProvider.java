...
public final class WaterDogPlatformManagerProvider extends PlatformPluginManagerProvider<String, Plugin> {

  public WaterDogPlatformManagerProvider() {
    super("waterdog", makeLazyLoader(WaterDogPlatformManagerProvider.class, "WaterDogPlatformPluginManager"));
  }
}
