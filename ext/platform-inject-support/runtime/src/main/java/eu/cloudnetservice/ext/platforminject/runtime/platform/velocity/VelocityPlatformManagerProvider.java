...
public final class VelocityPlatformManagerProvider
  extends PlatformPluginManagerProvider<String, PlatformedContainer<PluginContainer, ProxyServer>> {

  public VelocityPlatformManagerProvider() {
    super("velocity", makeLazyLoader(VelocityPlatformManagerProvider.class, "VelocityPlatformPluginManager"));
  }
}
