...
public final class SpongePlatformManagerProvider
  extends PlatformPluginManagerProvider<String, Container<PluginContainer>> {

  public SpongePlatformManagerProvider() {
    super("sponge", makeLazyLoader(SpongePlatformManagerProvider.class, "SpongePlatformPluginManager"));
  }
}
