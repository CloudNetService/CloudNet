...
public final class FabricPlatformManagerProvider extends PlatformPluginManagerProvider<Integer, Object> {

  public FabricPlatformManagerProvider() {
    super("fabric", makeLazyLoader(FabricPlatformManagerProvider.class, "FabricPlatformPluginManager"));
  }
}
