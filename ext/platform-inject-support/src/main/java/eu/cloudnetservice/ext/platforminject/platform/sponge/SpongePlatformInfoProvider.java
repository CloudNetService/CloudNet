...
package eu.cloudnetservice.ext.platforminject.platform.sponge;
...
public final class SpongePlatformInfoProvider extends BasePlatformInfoProvider<String, Container<PluginContainer>> {

  public SpongePlatformInfoProvider() {
    super(
      "sponge",
      SpongePlatformPluginManager::new,
