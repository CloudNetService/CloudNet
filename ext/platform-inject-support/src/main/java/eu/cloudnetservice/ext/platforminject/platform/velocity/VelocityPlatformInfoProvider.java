...
import eu.cloudnetservice.ext.platforminject.mapping.PlatformedContainer;
import eu.cloudnetservice.ext.platforminject.provider.BasePlatformInfoProvider;

public final class VelocityPlatformInfoProvider
  extends BasePlatformInfoProvider<String, PlatformedContainer<PluginContainer, ProxyServer>> {

  public VelocityPlatformInfoProvider() {
    super(
      "velocity",
      VelocityPlatformPluginManager::new,
