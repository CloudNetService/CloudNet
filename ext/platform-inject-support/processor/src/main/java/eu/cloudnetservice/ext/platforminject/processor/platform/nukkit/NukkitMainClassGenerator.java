...
final class NukkitMainClassGenerator extends MethodBasedMainClassGenerator {

  private static final TypeName PLUGIN_BASE_CLASS_NAME = ClassName.get("cn.nukkit.plugin", "PluginBase");

  public NukkitMainClassGenerator() {
    super("nukkit", "onEnable", "onDisable");
  }

  @Override
  protected void customizeType(@NonNull ParsedPluginData pluginData, @NonNull TypeSpec.Builder typeBuilder) {
    typeBuilder.superclass(PLUGIN_BASE_CLASS_NAME);
  }
