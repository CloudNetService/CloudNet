...
final class MinestomMainClassGenerator extends MethodBasedMainClassGenerator {

  private static final TypeName EXTENSION_CLASS_NAME = ClassName.get("net.minestom.server.extensions", "Extension");

  public MinestomMainClassGenerator() {
    super("minestom", "initialize", "terminate");
  }

  @Override
  protected void customizeType(@NonNull ParsedPluginData pluginData, @NonNull TypeSpec.Builder typeBuilder) {
    typeBuilder.superclass(EXTENSION_CLASS_NAME);
  }
