...
/**
 * The logger is designed to handle the application and has all the basic
 * capabilities to provide easy-to-use logging A logger can optionally process
 * messages asynchronously. However, it is not an obligation for the
 * implementation
 */
public interface ILogger extends ILogHandlerProvider<ILogger>, ILevelable,
   ...
   * incoming LogLevel.level. The LogEntry is allowed to handle
   *
  ...
  /**
   * Allows to post one LogEntry object into the logger, which invokes the
   * LogHandlers for this LogEntry instance
   *
  ...
  /**
   * Allows to post zero or more LogEntries into the logger, which invokes the
   * LogHandlers for this LogEntry instances
   *
  ...
  /**
   * Indicates, that the implementation of the logger has support for
   * asynchronously log handle
   *
   * @return true when the implementation has the support or false if the class
   * doesn't has any async features
   */
   ...
   *
   * @param level the LogLevel instance, from that the level integer value
   * should get
   */
  ...
  /**
   * An wrapper method for the last base method log(LogEntry) This method should
   * be a simply shortcut and bypasses an implementation of a LogEntry object
   */
  ...
  /**
   * An wrapper method for the last base method log(LogEntry) It has the default
   * LogLevel INFO
   * <p>
   * This method should be a simply shortcut and bypasses an implementation of a
   * LogEntry object
   *
   * @see LogEntry
   * @see LogLevel
