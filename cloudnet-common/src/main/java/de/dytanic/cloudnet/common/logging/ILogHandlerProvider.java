...
/**
 * An interface for a provider, which provides all log handlers for a log
 * handlers
 */
public interface ILogHandlerProvider<T extends ILogHandlerProvider> {

  /**
   * Adds a new ILogHandler instance, into the collection by the
   * LogHandlerProvider implementation
   *
  ...
  /**
   * Adds an array of ILogHandler instances, into the collection by the
   * LogHandlerProvider implementation
   *
  ...
  /**
   * Adds an Iterable of ILogHandler instances, into the collection by the
   * LogHandlerProvider implementation
   *
   * @param logHandlers the ILogHandler's implementation, which should append
   * @return the current implementation of the ILogHandlerProvider
  ...
  /**
   * Removes when contains the ILogHandler's reference into the internal
   * registry
   *
   ...
   * @return true if the ILogHandler instance contain on this LogHandlerProvider
   * object
   */
   ...
   * @return true if the ILogHandler's instances contain on this
   * LogHandlerProvider object
   */
