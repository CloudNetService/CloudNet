...
/**
 * The LogLevel indicates how relevant and essential information is to be
 * output. All LogEntry instances has a LogLevel, which describe his relevant
 * <p>
 * An LogLevel configure the async log printing feature for the logger, if the
 * logger implementation support asynchronously ILogHandler invocation
 *
 * @see LogEntry
 */
@Getter
...
public class LogLevel implements ILevelable {
  ...
  /**
   * The INFO level is the basic level, for normal messages like "The sun is
   * shining"
   * <p>
   ...
   * that can't describe with ERROR
   * <p>
   * Disallows asynchronously ILogHandler invocation
   */
  ...
  /**
   * Defines the permission, to execute the LogEntries on this Level
