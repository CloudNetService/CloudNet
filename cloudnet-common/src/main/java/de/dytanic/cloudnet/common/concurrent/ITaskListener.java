 ...
 *
 * @param <T> the type of the listener, which should accept if the operation
 * from the ITask<V> instance is complete
 * @see ITask
 */
public interface ITaskListener<T> {

  /**
   * An default implementation that prints an error into the System.err stream,
