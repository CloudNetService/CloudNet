...
/**
 * This is a basic abstract implementation of the ILogHandler class. It should
 * help, to create a simple
 */
@NoArgsConstructor
@AllArgsConstructor
public abstract class AbstractLogHandler implements ILogHandler {
  ...
  /**
   * A formatter with a default initialization value with the
