...
/**
 * All println and print methods can be executed completely asynchronously at
 * each instance of this class, and these are then executed synchronously in the
 * single thread. It should optimize performance and avoid blocking between
 * thread contexts
 * <p>
 * The actual console output is still executed in a thread where its priority is
 * as low as possible to affect the program even less
 */
@Getter
