...
public final class WildcardUtil {
     ...
     */
    @NotNull
    public static <T extends INameable> Collection<T> filterWildcard(@NotNull Collection<T> inputValues, @NotNull String regex) {
     ...
     */
    @NotNull
    public static <T extends INameable> Collection<T> filterWildcard(@NotNull Collection<T> inputValues, @NotNull String regex, boolean caseSensitive) {
        Preconditions.checkNotNull(inputValues, "inputValues");
        Preconditions.checkNotNull(regex, "regex");
     ...
     * @return {@code true} if any of the values matches the given regex.
     */
    public static boolean anyMatch(@NotNull Collection<? extends INameable> values, @NotNull String regex, boolean caseSensitive) {
        Preconditions.checkNotNull(values, "values");
        Preconditions.checkNotNull(regex, "regex");
    ...
    /**
     * Prepares the given {@code regex} string, grouping every {@literal *} in
     * the provided string to a separate regex group.
     *
    ...
    /**
     * Tries to compile the given pattern string and tries to automatically fix it
     * if the input {@code pattern} is not compilable.
     *
    ...
    /**
     * Searches for unclosed groups in the given {@code patternInput} and replaces the
     * group openers {@literal (} with an escaped {@literal \(} while taking care of
     * completed groups.
     *
