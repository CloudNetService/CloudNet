...
/**
 * The ServicesRegistry, is to be able to manage and summarize implementations
 * of interfaces and abstract classes in order to make them dynamically
 * retrievable.
 */
public interface IServicesRegistry {

  /**
   * Registers a new service from the basic parent class. and can get with the
   * following key
   *
   ...
   * @param <T> the interface or abstract type which you want the implementation
   * providing for
   * @param <E> the implementation of the service type T
   * @return the current instance, of the class, which was used to offerTask
   * this method
   */
  ...
  /**
   * Unregisters a service by the name of the service on a specific class
   * provider
   *
  ...
  /**
   * Removes all services from the registry, which has the following provider
   * class
   *
   * @param clazz the provider base class from that should all services be
   * removed
   * @param <T> the interface or abstract type which you want the implementation
   * providing for
   * @return the current instance of the ServiceRegistry
   ...
   *
   * @param classLoader the classLoader, from that all services should be
   * removed
   * @return the current instance of the ServiceRegistry
   */
   ...
   * @param <T> the interface or abstract type which you want the implementation
   * providing for
   * @return the service implementation of the base class or the base class
   * himself
   */
   ...
   * @param <T> the interface or abstract type which you want the implementation
   * providing for
   * @return the service implementations of the base class or the base class
   * himself
   */
