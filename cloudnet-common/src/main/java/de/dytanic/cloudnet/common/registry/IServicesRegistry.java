...
/**
 * The ServicesRegistry, is to be able to manage and
 * summarize implementations of interfaces and abstract
 * classes in order to make them dynamically retrievable.
 */
