 ...
 * com.sun.management.OperatingSystemMXBean class and to encapsulate the
 * operations from the unsafe access com.sun.management.* classes
 *
...
public final class CPUUsageResolver {
  ...
  /**
   * For encapsulation and easy operation of the operating systemMXBean its
   * getCpuLoad() method.
   *
   ...
   * getCpuLoad() method.
   *
   * @return the cpu usage of this JVM process as double value in range from 0
   * to 100 % in percent
   * @see com.sun.management.OperatingSystemMXBean
   */
