...
/**
 * The default implementation of the ILogger interface. The the logger executes
 * the registered logHandlers asynchronously by default or synchronously if the
 * LogLevel disallow async log handling
 */
