...
/**
 * The methods on this class can check some states or number validations of
 * strings
 */
public final class Validate {
  ...
  /**
   * Proof ob the input argument is null and throws an NullPointerException when
   * the value is null
   *
   ...
   *
   * @param object the input argument which you check is null
   * @param message The following message, which should output if the object is
   * null
   * @param <T> the generic type of the input argument
   * @return the same instance which you add into the first parameter
   */
  ...
  /**
   * Excepted that the following condition is true. If is not it throws an
  ...
  /**
   * Excepted that the following condition is false. If is not it throws an
   * IllegalArgumentException
   *
   * @param value the following condition which should checked
   * @return false
  ...
  /**
   * Tests that the following input string can be parse to int or not It invokes
   * to test the Integer.parseInt() method
   *
  ...
  /**
   * Tests that the following input string can be parse to double or not It
   * invokes to test the Double.parseDouble() method
   *
   * @param input the following test string
  ...
  /**
   * Tests that the following input string can be parse to long or not It
   * invokes to test the Long.parseLong() method
   *
   * @param input the following test string
