...
public class VelocityLuckPermsPlugin implements PlatformEntrypoint {
  ...
  @Inject
  public VelocityLuckPermsPlugin(ServiceInfoHolder serviceInfoHolder) {
    this.serviceInfoHolder = serviceInfoHolder;
  }

  @Override
  public void onLoad() {
    LuckPermsProvider.get().getContextManager()
      .registerCalculator(new CloudNetContextCalculator(this.serviceInfoHolder));
  }
}
