...
public interface ICommandMap {
  ...
  /**
   * Unregister all commands from the map, that has the following string as
   * name
   *
  ...
  /**
   * Unregister all commands from the map, that command instance class is like
   * the argument
   *
   ...
   *
   * @param classLoader the classLoader from that all commands, that are contain
   * will remove
   */
  ...
  /**
   * Transform all commands instances that are contain in the map into a
   * CommandInfo object
   */
  ...
  /**
   * Returns the command in the map with a specific name. If the name is more
   * than one exist. The first command instance that could be found will return
   *
  ...
  /**
   * Invokes a command execute() method when there is contain in the map and
   * parsed from the command line the additional properties.
   *
   ...
   * @return true if the command will successful executed or false when the
   * command cannot be found in the map or an exception was thrown
   */
  ...
  /**
   * Unregister all commands from the map, that command instance classes is like
   * the argument
   *
