...
public abstract class SubCommand implements SubCommandExecutor {
     ...
     * Static strings ({@link SubCommandArgumentTypes#exactString(String)} {@link SubCommandArgumentTypes#anyString(String...)} or the ignore case methods)
     * are never wrapped with brackets.<br>
     * <br>
     * Dynamic strings (any other {@link QuestionAnswerType}) are wrapped with "&lt;&gt;" if they are required and
     * with "[]" if they are optional (this can be set with the {@link #setMinArgs(int)} and {@link #setMaxArgs(int)} methods).
     *
