...
import de.dytanic.cloudnet.deleted.command.DefaultCommandMap;
import de.dytanic.cloudnet.deleted.command.ICommandMap;
import de.dytanic.cloudnet.deleted.command.commands.CommandClear;
import de.dytanic.cloudnet.deleted.command.commands.CommandCluster;
import de.dytanic.cloudnet.deleted.command.commands.CommandCopy;
import de.dytanic.cloudnet.deleted.command.commands.CommandCreate;
import de.dytanic.cloudnet.deleted.command.commands.CommandDebug;
import de.dytanic.cloudnet.deleted.command.commands.CommandExit;
import de.dytanic.cloudnet.deleted.command.commands.CommandGroups;
import de.dytanic.cloudnet.deleted.command.commands.CommandHelp;
import de.dytanic.cloudnet.deleted.command.commands.CommandMe;
import de.dytanic.cloudnet.deleted.command.commands.CommandMigrate;
import de.dytanic.cloudnet.deleted.command.commands.CommandModules;
import de.dytanic.cloudnet.deleted.command.commands.CommandPermissions;
import de.dytanic.cloudnet.deleted.command.commands.CommandReload;
import de.dytanic.cloudnet.deleted.command.commands.CommandScreen;
import de.dytanic.cloudnet.deleted.command.commands.CommandService;
import de.dytanic.cloudnet.deleted.command.commands.CommandTasks;
