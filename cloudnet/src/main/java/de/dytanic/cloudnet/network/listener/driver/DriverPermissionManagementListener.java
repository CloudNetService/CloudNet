...
public class DriverPermissionManagementListener extends CategorizedDriverAPIListener {
    public DriverPermissionManagementListener() {
        ...
        super.registerHandler(DriverAPIRequestType.PERMISSION_MANAGEMENT_DELETE_USERS_BY_NAME, (channel, packet, buffer) -> {
        ...
        super.registerHandler(DriverAPIRequestType.PERMISSION_MANAGEMENT_DELETE_GROUP_BY_NAME, (channel, packet, buffer) -> {
            String name = buffer.readString();
        ...
        super.registerHandler(DriverAPIRequestType.PERMISSION_MANAGEMENT_CONTAINS_USER_BY_UNIQUE_ID, (channel, packet, buffer) -> {
        ...
        super.registerHandler(DriverAPIRequestType.PERMISSION_MANAGEMENT_CONTAINS_USER_BY_NAME, (channel, packet, buffer) -> {
            boolean contains = this.permissionManagement().containsUser(buffer.readString());
            return ProtocolBuffer.create().writeBoolean(contains);
        });

        super.registerHandler(DriverAPIRequestType.PERMISSION_MANAGEMENT_GET_USER_BY_UNIQUE_ID, (channel, packet, buffer) -> {
        ...
        super.registerHandler(DriverAPIRequestType.PERMISSION_MANAGEMENT_GET_FIRST_USER_BY_NAME, (channel, packet, buffer) -> {
