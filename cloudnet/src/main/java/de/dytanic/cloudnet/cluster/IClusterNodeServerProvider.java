 ...
 */
public interface IClusterNodeServerProvider extends AutoCloseable, IPacketSender, NodeServerProvider {
     ...
     * @return the IClusterNodeServer instance or null if the node isn't registered
     */
    @Override
    @Nullable
