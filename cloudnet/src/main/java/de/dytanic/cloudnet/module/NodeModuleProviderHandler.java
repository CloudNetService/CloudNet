...
public final class NodeModuleProviderHandler implements IModuleProviderHandler {
  ...
  public void handlePreModuleLoad(IModuleWrapper moduleWrapper) {
    this.callEvent(
      new ModulePreLoadEvent(this.getModuleProvider(), moduleWrapper));
    this.getLogger().info(
      replaceAll(LanguageManager.getMessage("cloudnet-pre-load-module"),
  ...
  public void handlePostModuleLoad(IModuleWrapper moduleWrapper) {
    this.callEvent(
      new ModulePostLoadEvent(this.getModuleProvider(), moduleWrapper));
    this.getLogger().info(
      replaceAll(LanguageManager.getMessage("cloudnet-post-load-module"),
        this.getModuleProvider(), moduleWrapper));
  }
  ...
  public void handlePreModuleStart(IModuleWrapper moduleWrapper) {
    this.callEvent(
      new ModulePreStartEvent(this.getModuleProvider(), moduleWrapper));
    this.getLogger().info(
      replaceAll(LanguageManager.getMessage("cloudnet-pre-start-module"),
        this.getModuleProvider(), moduleWrapper));

    CloudNetDriver.getInstance().getEventManager()
      .registerListener(moduleWrapper.getModule());
  }

  @Override
  public void handlePostModuleStart(IModuleWrapper moduleWrapper) {
    this.callEvent(
      new ModulePostStartEvent(this.getModuleProvider(), moduleWrapper));
    this.getLogger().info(
      replaceAll(LanguageManager.getMessage("cloudnet-post-start-module"),
        this.getModuleProvider(), moduleWrapper));
  }
  ...
  public void handlePreModuleStop(IModuleWrapper moduleWrapper) {
    this.callEvent(
      new ModulePreStopEvent(this.getModuleProvider(), moduleWrapper));
    this.getLogger().info(
      replaceAll(LanguageManager.getMessage("cloudnet-pre-stop-module"),
        this.getModuleProvider(), moduleWrapper));
  }
  ...
  public void handlePostModuleStop(IModuleWrapper moduleWrapper) {
    CloudNetDriver.getInstance().getServicesRegistry()
      .unregisterAll(moduleWrapper.getClassLoader());
    CloudNetDriver.getInstance().getEventManager()
      .unregisterListeners(moduleWrapper.getClassLoader());
    CloudNet.getInstance()
      .unregisterPacketListenersByClassLoader(moduleWrapper.getClassLoader());
    CloudNet.getInstance().getHttpServer()
      .removeHandler(moduleWrapper.getClassLoader());
    CloudNet.getInstance().getCommandMap()
      .unregisterCommands(moduleWrapper.getClassLoader());

    this.callEvent(
      new ModulePostStopEvent(this.getModuleProvider(), moduleWrapper));
    this.getLogger().info(
      replaceAll(LanguageManager.getMessage("cloudnet-post-stop-module"),
        this.getModuleProvider(), moduleWrapper));
    CloudNetDriver.getInstance().getEventManager()
      .unregisterListeners(moduleWrapper.getClassLoader());
  }
  ...
  public void handlePreModuleUnload(IModuleWrapper moduleWrapper) {
    this.callEvent(
      new ModulePreUnloadEvent(this.getModuleProvider(), moduleWrapper));
    this.getLogger().info(
      replaceAll(LanguageManager.getMessage("cloudnet-pre-unload-module"),
        this.getModuleProvider(), moduleWrapper));
  }
  ...
  public void handlePostModuleUnload(IModuleWrapper moduleWrapper) {
    this.callEvent(
      new ModulePostUnloadEvent(this.getModuleProvider(), moduleWrapper));
    this.getLogger().info(
      replaceAll(LanguageManager.getMessage("cloudnet-post-unload-module"),
        this.getModuleProvider(), moduleWrapper));
  }
  ...
  public void handlePreInstallDependency(IModuleWrapper moduleWrapper,
    ...
    this.callEvent(new ModulePreInstallDependencyEvent(this.getModuleProvider(),
      moduleWrapper, dependency));
    this.getLogger().info(replaceAll(
      LanguageManager.getMessage("cloudnet-pre-install-dependency-module")
  ...
  public void handlePostInstallDependency(IModuleWrapper moduleWrapper,
    ModuleDependency dependency) {
    this.callEvent(
      new ModulePostInstallDependencyEvent(this.getModuleProvider(),
        moduleWrapper, dependency));
    this.getLogger().info(replaceAll(
      LanguageManager.getMessage("cloudnet-post-install-dependency-module")
        .replace("%group%", dependency.getGroup() + "")
        .replace("%name%", dependency.getName() + "")
        .replace("%version%", dependency.getVersion() + "")
      , this.getModuleProvider(), moduleWrapper));
  ...
  private String replaceAll(String text, IModuleProvider moduleProvider,
    ...
    return text.replace("%module_group%",
