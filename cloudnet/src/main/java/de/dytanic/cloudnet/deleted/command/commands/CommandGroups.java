  ...
  public CommandGroups() {
    super(
      SubCommandBuilder.create()
        ...
        .prefix(SubCommandArgumentTypes.exactStringIgnoreCase("group"))
        ...
        .generateCommand(
          ...
          SubCommandArgumentTypes.anyStringIgnoreCase("environment", "env"),
        ...
        .generateCommand(
          ...
          SubCommandArgumentTypes.exactStringIgnoreCase("remove"),
          SubCommandArgumentTypes.anyStringIgnoreCase("environment", "env"),
          SubCommandArgumentTypes.exactEnum(ServiceEnvironmentType.class)
        )
