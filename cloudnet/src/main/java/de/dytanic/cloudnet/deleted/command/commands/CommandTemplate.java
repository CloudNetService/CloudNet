    ...
    super(
      SubCommandBuilder.create()
        ...
        .generateCommand(
          ...
          SubCommandArgumentTypes.exactStringIgnoreCase("versions")
        )
        ...
        .generateCommand(
          ...
          SubCommandArgumentTypes.exactStringIgnoreCase("install"),
          SubCommandArgumentTypes.template("template", true),
          SubCommandArgumentTypes.dynamicString(
            "versionType",
        ...
        .generateCommand(
          ...
          SubCommandArgumentTypes.anyStringIgnoreCase("delete", "remove", "rm"),
          SubCommandArgumentTypes.template("template", true)
        )
        ...
        .generateCommand(
          ...
          SubCommandArgumentTypes.anyStringIgnoreCase("create", "new"),
          SubCommandArgumentTypes.template("template"),
        ...
        .generateCommand(
          ...
          SubCommandArgumentTypes.anyStringIgnoreCase("copy", "cp"),
          SubCommandArgumentTypes.template("storage:prefix/name (sourceTemplate)"),
          SubCommandArgumentTypes.template("storage:prefix/name (targetTemplate)")
        )
