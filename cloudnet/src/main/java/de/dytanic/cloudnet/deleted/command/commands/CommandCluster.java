    ...
    super(
      SubCommandBuilder.create()
        ...
        .generateCommand(
          ...
          SubCommandArgumentTypes.anyStringIgnoreCase("shutdown", "stop")
        )
        .generateCommand(
          (subCommand, sender, command, args, commandLine, properties, internalProperties) -> {
          ...
          SubCommandArgumentTypes.validHostAndPort("host")
        )
        .generateCommand(
          (subCommand, sender, command, args, commandLine, properties, internalProperties) -> {
            IConfiguration cloudConfiguration = CloudNet.getInstance().getConfig();
        ...
        .generateCommand(
          ...
          SubCommandArgumentTypes.exactStringIgnoreCase("nodes")
        )
        .generateCommand(
          (subCommand, sender, command, args, commandLine, properties, internalProperties) -> {
          ...
          SubCommandArgumentTypes.anyStringIgnoreCase("node"),
          SubCommandArgumentTypes.dynamicString(
            "nodeId",
            LanguageManager.getMessage("command-cluster-node-not-found"),
        ...
        .prefix(SubCommandArgumentTypes.exactStringIgnoreCase("push"))
        ...
        .generateCommand(
          ...
          SubCommandArgumentTypes.anyStringIgnoreCase("all", "*")
        )
        .generateCommand(
