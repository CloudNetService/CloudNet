    ...
    super(
      SubCommandBuilder.create()
        ...
        .generateCommand(
          ...
          SubCommandArgumentTypes.anyStringIgnoreCase("disableAll", "d")
        )
        ...
        .generateCommand(
          ...
          SubCommandArgumentTypes.anyStringIgnoreCase("toggle", "t"),
        ...
        .generateCommand(
          ...
          SubCommandArgumentTypes.anyStringIgnoreCase("write", "send", "w"),
