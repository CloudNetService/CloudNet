  ...
  protected static void handleGeneralAddCommands(SubCommandBuilder builder,
    ...
    builder
      ...
      .generateCommand(
        ...
        SubCommandArgumentTypes.template("storage:prefix/name", true),
      ...
      .generateCommand(
        ...
        SubCommandArgumentTypes.exactStringIgnoreCase("jvmOption"),
      ...
      .generateCommand(
        ...
        subCommand -> subCommand.setMinArgs(subCommand.getRequiredArguments().length).setMaxArgs(Integer.MAX_VALUE),
        SubCommandArgumentTypes.exactStringIgnoreCase("processParameter"),
        SubCommandArgumentTypes.dynamicString("value")
      )
  ...
  protected static void handleGeneralRemoveCommands(SubCommandBuilder builder,
    ...
    builder
      ...
      .generateCommand(
        ...
        SubCommandArgumentTypes.exactStringIgnoreCase("clear"),
        SubCommandArgumentTypes.exactStringIgnoreCase("jvmOptions")
      )
