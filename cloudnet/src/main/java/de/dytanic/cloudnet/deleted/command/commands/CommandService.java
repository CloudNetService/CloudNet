    ...
    super(
      SubCommandBuilder.create()
        ...
        .generateCommand(
          ...
          SubCommandArgumentTypes.anyStringIgnoreCase("list", "l")
        )
        ...
        .generateCommand(
          ...
          SubCommandArgumentTypes.anyStringIgnoreCase("info", "i")
        )

        .generateCommand(
          (subCommand, sender, command, args, commandLine, properties, internalProperties) -> forEachService(
            internalProperties, serviceInfoSnapshot -> serviceInfoSnapshot.provider().start()),
          SubCommandArgumentTypes.exactStringIgnoreCase("start")
        )
        .generateCommand(
          (subCommand, sender, command, args, commandLine, properties, internalProperties) -> {
        ...
        .generateCommand(
          ...
          SubCommandArgumentTypes.anyStringIgnoreCase("command", "cmd"),
          SubCommandArgumentTypes.dynamicString("command")
        )
        ...
        .generateCommand(
          ...
          SubCommandArgumentTypes.exactStringIgnoreCase("deployment"),
          SubCommandArgumentTypes.template("storage:prefix/name"),
          SubCommandArgumentTypes.collection("excludedFiles separated by \";\"")
        )
        .generateCommand(
          (subCommand, sender, command, args, commandLine, properties, internalProperties) -> forEachService(
            internalProperties, serviceInfoSnapshot -> {
          ...
          SubCommandArgumentTypes.exactStringIgnoreCase("template"),
          SubCommandArgumentTypes.template("storage:prefix/name")
        )
        .generateCommand(
          (subCommand, sender, command, args, commandLine, properties, internalProperties) -> forEachService(
          ...
          SubCommandArgumentTypes.exactStringIgnoreCase("inclusion"),
          SubCommandArgumentTypes.url("url"),
          SubCommandArgumentTypes.dynamicString("targetPath")
        )
