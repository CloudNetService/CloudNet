...
import de.dytanic.cloudnet.deleted.command.sub.SubCommand;
    ...
    super(
      SubCommandBuilder.create()
        ...
        .generateCommand(
          ...
          SubCommandArgumentTypes.exactStringIgnoreCase("setup")
        )
        ...
        .generateCommand((subCommand, sender, command, args, commandLine, properties, internalProperties) -> {
          ...
          SubCommandArgumentTypes.exactStringIgnoreCase("list"))

        .applyHandler(CommandTasks::handleCreateCommands)
        .applyHandler(CommandTasks::handleDeleteCommands)

        .prefix(SubCommandArgumentTypes.exactStringIgnoreCase("task"))
      ...
      .generateCommand(
        (subCommand, sender, command, args, commandLine, properties, internalProperties) -> {
          try {
            ...
            Command.LOGGER.severe("Exception while creating task", exception);
          }
        },
        SubCommandArgumentTypes.exactStringIgnoreCase("create"),
        ...
        SubCommandArgumentTypes.exactEnum(ServiceEnvironmentType.class)
      )
  ...
  private static void handleDeleteCommands(SubCommandBuilder builder) {
    builder
      .generateCommand(
        ...
        SubCommandArgumentTypes.exactStringIgnoreCase("delete"),
        SubCommandArgumentTypes.dynamicString(
          "name",
          LanguageManager.getMessage("command-tasks-task-not-found"),
          name -> CloudNet.getInstance().getServiceTaskProvider().isServiceTaskPresent(name),
  ...
  private static void handleTaskSetCommands(SubCommandBuilder builder) {
    builder
      ...
      .generateCommand(
        ...
        SubCommandArgumentTypes.exactStringIgnoreCase("minServiceCount"),
        SubCommandArgumentTypes.integer("amount", amount -> amount >= 0)
      )
      .generateCommand(
        (subCommand, sender, command, args, commandLine, properties, internalProperties) ->
          forEachTasks(
        ...
        SubCommandArgumentTypes.exactStringIgnoreCase("maintenance"),
        SubCommandArgumentTypes.bool("enabled")
      )
      .generateCommand(
        (subCommand, sender, command, args, commandLine, properties, internalProperties) ->
          forEachTasks(
        ...
        SubCommandArgumentTypes.exactStringIgnoreCase("maxHeapMemory"),
        SubCommandArgumentTypes.integer("memory", memory -> memory > 0)
      )
      .generateCommand(
        (subCommand, sender, command, args, commandLine, properties, internalProperties) ->
          forEachTasks(
        ...
        SubCommandArgumentTypes.exactStringIgnoreCase("startPort"),
        SubCommandArgumentTypes.integer("startPort", 0, 65535)
      )
      .generateCommand(
        (subCommand, sender, command, args, commandLine, properties, internalProperties) ->
          forEachTasks(
        ...
        SubCommandArgumentTypes.exactStringIgnoreCase("autoDeleteOnStop"),
        SubCommandArgumentTypes.bool("autoDeleteOnStop")
      )
      .generateCommand(
        (subCommand, sender, command, args, commandLine, properties, internalProperties) ->
          forEachTasks(
        ...
        SubCommandArgumentTypes.exactStringIgnoreCase("staticServices"),
        SubCommandArgumentTypes.bool("staticServices")
      )
      .generateCommand(
        (subCommand, sender, command, args, commandLine, properties, internalProperties) ->
          forEachTasks(
        ...
        SubCommandArgumentTypes.exactStringIgnoreCase("environment"),
        SubCommandArgumentTypes.exactEnum(ServiceEnvironmentType.class)
      )
      .generateCommand(
        (subCommand, sender, command, args, commandLine, properties, internalProperties) ->
        ...
        SubCommandArgumentTypes.exactStringIgnoreCase("disableIpRewrite"),
        SubCommandArgumentTypes.bool("value")
      )
      .generateCommand(
        (subCommand, sender, command, args, commandLine, properties, internalProperties) ->
          forEachTasks(
        ...
        SubCommandArgumentTypes.exactStringIgnoreCase("javaCommand"),
        SubCommandArgumentTypes.dynamicString("value")
      )
  ...
  private static void handleTaskAddCommands(SubCommandBuilder builder) {
    builder
      ...
      .generateCommand(
        ...
        SubCommandArgumentTypes.exactStringIgnoreCase("node"),
        SubCommandArgumentTypes.dynamicString(
          "uniqueId",
      ...
      .generateCommand(
        ...
        SubCommandArgumentTypes.exactStringIgnoreCase("group"),
        SubCommandArgumentTypes.dynamicString(
          "name",
  ...
  private static void setupTask(IConsole console, ICommandSender sender) {
    ...
    animation.addFinishHandler(() -> {
      ...
      try {
        ...
        Command.LOGGER.severe("Exception while creating templates", exception);
      }
