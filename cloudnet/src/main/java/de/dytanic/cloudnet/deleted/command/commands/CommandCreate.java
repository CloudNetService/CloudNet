    ...
    super(
      SubCommandBuilder.create()
        ...
        .generateCommand(
          ...
          SubCommandArgumentTypes.exactStringIgnoreCase("by"),
          ...
          SubCommandArgumentTypes.positiveInteger("count")
        )
        ...
        .generateCommand(
          (subCommand, sender, command, args, commandLine, properties, internalProperties) -> {
            ...
            try {
              ...
              Command.LOGGER.severe("Exception while creating services", exception);
            }
          },
          subCommand -> subCommand.async().enableProperties()
            .appendUsage("\n" +
          ...
          SubCommandArgumentTypes.exactStringIgnoreCase("new"),
