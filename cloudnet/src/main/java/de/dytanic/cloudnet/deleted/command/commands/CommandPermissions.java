...
import de.dytanic.cloudnet.deleted.command.ConsoleCommandSender;
import de.dytanic.cloudnet.deleted.command.ICommandSender;
import de.dytanic.cloudnet.deleted.command.sub.CommandInterrupt;
import de.dytanic.cloudnet.deleted.command.sub.SubCommandArgumentTypes;
import de.dytanic.cloudnet.deleted.command.sub.SubCommandArgumentWrapper;
...
public class CommandPermissions extends SubCommandHandler {
    ...
    super(
      SubCommandBuilder.create()
        ...
        .generateCommand(
          ...
          SubCommandArgumentTypes.anyStringIgnoreCase("reload", "rl")
        )

        .prefix(SubCommandArgumentTypes.anyStringIgnoreCase("create", "new"))
        .applyHandler(CommandPermissions::handleCreateCommands)
        .removeLastPrefix()

        .prefix(SubCommandArgumentTypes.anyStringIgnoreCase("delete", "remove"))
        .applyHandler(CommandPermissions::handleDeleteCommands)
        .removeLastPrefix()

        .prefix(SubCommandArgumentTypes.anyStringIgnoreCase("user", "u"))
        .applyHandler(CommandPermissions::handleUserCommands)
        .removeLastPrefix()

        .prefix(SubCommandArgumentTypes.anyStringIgnoreCase("group", "g"))
  ...
  private static void handleCreateCommands(SubCommandBuilder builder) {
    builder
      .generateCommand(
        ...
        SubCommandArgumentTypes.anyStringIgnoreCase("user", "u"),
        SubCommandArgumentTypes.dynamicString(
          "name",
        ...
        SubCommandArgumentTypes.dynamicString("password"),
        SubCommandArgumentTypes.integer("potency")
      )
      .generateCommand(
        (subCommand, sender, command, args, commandLine, properties, internalProperties) -> {
        ...
        SubCommandArgumentTypes.anyStringIgnoreCase("group", "g"),
        SubCommandArgumentTypes.dynamicString(
          "name",
  ...
  private static void handleUserCommands(SubCommandBuilder builder) {
    builder
      .prefix(SubCommandArgumentTypes.dynamicString(
        "user",
        LanguageManager.getMessage("command-permissions-user-not-found"),
        input -> CloudNet.getInstance().getPermissionManagement().containsUser(input)
      ))
      ...
      .generateCommand(
        ...
        SubCommandArgumentTypes.exactStringIgnoreCase("rename"),
        SubCommandArgumentTypes.dynamicString("name")
      )
      .generateCommand(
        (subCommand, sender, command, args, commandLine, properties, internalProperties) -> {
          IPermissionUser user = (IPermissionUser) internalProperties.get("user");
        ...
        SubCommandArgumentTypes.exactStringIgnoreCase("changePassword"),
        SubCommandArgumentTypes.dynamicString("password")
      )
      .generateCommand(
        (subCommand, sender, command, args, commandLine, properties, internalProperties) -> {
        ...
        SubCommandArgumentTypes.exactStringIgnoreCase("check"),
        SubCommandArgumentTypes.dynamicString("password")
      )
      ...
      .generateCommand(
        ...
        SubCommandArgumentTypes.exactStringIgnoreCase("add"),
        SubCommandArgumentTypes.anyStringIgnoreCase("group", "g"),
        SubCommandArgumentTypes.dynamicString(
          "name",
          LanguageManager.getMessage("command-permissions-group-not-found"),
      ...
      .generateCommand(
        ...
        SubCommandArgumentTypes.anyStringIgnoreCase("remove", "rm"),
        SubCommandArgumentTypes.anyStringIgnoreCase("group", "g"),
        SubCommandArgumentTypes.dynamicString("group")
  ...
  private static void handleGroupCommands(SubCommandBuilder builder) {
    builder
      ...
      .prefix(SubCommandArgumentTypes.exactStringIgnoreCase("set"))
      .postExecute(
        (subCommand, sender, command, args, commandLine, properties, internalProperties) -> {
      ...
      .generateCommand(
        ...
        SubCommandArgumentTypes.exactStringIgnoreCase("sortId"),
        SubCommandArgumentTypes.positiveInteger("sortId")
      )
      .generateCommand(
        (subCommand, sender, command, args, commandLine, properties, internalProperties) -> ((IPermissionGroup) internalProperties
          .get("group")).setDisplay((String) args.argument(4)),
        subCommand -> subCommand.setMinArgs(5).setMaxArgs(Integer.MAX_VALUE),
        SubCommandArgumentTypes.exactStringIgnoreCase("display"),
        SubCommandArgumentTypes.dynamicString("display")
      )
      .generateCommand(
        (subCommand, sender, command, args, commandLine, properties, internalProperties) -> ((IPermissionGroup) internalProperties
          .get("group")).setPrefix((String) args.argument(4)),
        subCommand -> subCommand.setMinArgs(5).setMaxArgs(Integer.MAX_VALUE),
        SubCommandArgumentTypes.exactStringIgnoreCase("prefix"),
        SubCommandArgumentTypes.dynamicString("prefix")
      )
      .generateCommand(
        (subCommand, sender, command, args, commandLine, properties, internalProperties) -> ((IPermissionGroup) internalProperties
          .get("group")).setSuffix((String) args.argument(4)),
        subCommand -> subCommand.setMinArgs(5).setMaxArgs(Integer.MAX_VALUE),
        SubCommandArgumentTypes.exactStringIgnoreCase("suffix"),
        SubCommandArgumentTypes.dynamicString("suffix")
      )
      .generateCommand(
        (subCommand, sender, command, args, commandLine, properties, internalProperties) -> ((IPermissionGroup) internalProperties
          .get("group")).setDefaultGroup((boolean) args.argument(4)),
        SubCommandArgumentTypes.exactStringIgnoreCase("defaultGroup"),
        SubCommandArgumentTypes.bool("defaultGroup")
      )
      ...
      .generateCommand(
        ...
        SubCommandArgumentTypes.exactStringIgnoreCase("color"),
        SubCommandArgumentTypes.dynamicString("color", 2)
      )
      .removeLastPrefix()
  ...
  private static void handlePermissionCommands(SubCommandBuilder builder,
    ...
    builder
      .prefix(SubCommandArgumentTypes.exactStringIgnoreCase("add"))
      .prefix(SubCommandArgumentTypes.anyStringIgnoreCase("permission", "perm"))
      .prefix(SubCommandArgumentTypes.dynamicString("permission"))
      ...
      .prefix(SubCommandArgumentTypes.anyStringIgnoreCase("remove", "rm"))
