...
/**
 * This class loader is a bridge which should replace the AppClassLoader and
 * access the AppClassLoader if classes are not found. This allows the actual
 * service to access the benefits of the SystemClassLoader.
 */
