...
/**
 * The RuntimeAgent provides the setup for all actions after the main method of this wrapper
 */
public final class RuntimeAgent {

    /**
     * The instance of the Instrumentation which is from the premain() method added
     *
     * @see Instrumentation
     */
    @Getter
