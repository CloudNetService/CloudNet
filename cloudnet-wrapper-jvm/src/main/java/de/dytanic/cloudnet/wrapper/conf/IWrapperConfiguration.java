...
/**
 * The configuration mirror of the .wrapper/wrapper.json file in the working folder from the service process.
 * It includes all important data for the Wrapper to connect with the local node.
 * <p>
...
public interface IWrapperConfiguration {
    ...
    /**
     * The first serviceInfoSnapshot which has the important data for all next serviceInfoSnapshots, which the wrapper has to create
     *
