...
/**
 * A redirect log handler, to the origin output and error stream. The
 * LogOutputStream will replace the System.out and System.err stream after this
 * initialization by the Wrapper
 */
