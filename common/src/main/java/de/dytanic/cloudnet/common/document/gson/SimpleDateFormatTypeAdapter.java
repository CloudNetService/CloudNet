...
final class SimpleDateFormatTypeAdapter extends TypeAdapter<SimpleDateFormat> {
  ...
  @Override
  public void write(JsonWriter jsonWriter, SimpleDateFormat simpleDateFormat) throws IOException {
    TypeAdapters.STRING.write(jsonWriter, simpleDateFormat.toPattern());
  }
