...
import eu.cloudnetservice.cloudnet.node.service.defaults.config.WaterdogPEConfigurationPreparer;
import eu.cloudnetservice.cloudnet.node.service.defaults.factory.JVMServiceFactory;
import eu.cloudnetservice.cloudnet.node.service.defaults.provider.EmptySpecificCloudServiceProvider;
import eu.cloudnetservice.cloudnet.node.service.defaults.provider.RemoteNodeCloudServiceProvider;
