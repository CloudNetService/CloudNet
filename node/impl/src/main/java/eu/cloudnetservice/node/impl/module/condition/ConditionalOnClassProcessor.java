...
import eu.cloudnetservice.node.module.condition.ConditionalOnClass;
 ...
 */
@Singleton
@AutoService(services = ConditionProcessor.class, name = "eu.cloudnetservice.node.module.condition.ConditionalOnClass")
public final class ConditionalOnClassProcessor implements ConditionProcessor {
  ...
  public @NonNull Class<? extends java.lang.annotation.Annotation> annotation() {
    return ConditionalOnClass.class;
  }
