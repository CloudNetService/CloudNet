...
public final class ConfigCommand {
  ...
  @Parser(name = "ipAlias")
  public @NonNull String ipAliasParser(@NonNull I18n i18n, @NonNull CommandInput input) {
  ...
  public void reloadConfigs(@NonNull I18n i18n, @NonNull CommandSource source) {
  ...
  public void reloadNodeConfig(@NonNull I18n i18n, @NonNull CommandSource source) {
    this.configuration.reloadFrom(JsonConfiguration.loadFromFile());
