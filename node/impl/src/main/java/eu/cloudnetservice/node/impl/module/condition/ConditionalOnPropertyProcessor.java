...
import eu.cloudnetservice.node.module.condition.ConditionalOnProperty;
 ...
 */
@Singleton
@AutoService(services = ConditionProcessor.class, name = "eu.cloudnetservice.node.module.condition.ConditionalOnProperty")
