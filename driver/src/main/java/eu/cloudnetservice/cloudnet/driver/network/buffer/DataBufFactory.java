...
import eu.cloudnetservice.cloudnet.driver.network.netty.buffer.NettyDataBufFactory;
...
public interface DataBufFactory {
   ...
   * @throws com.google.common.base.VerifyException if the buffer cannot be copied.
