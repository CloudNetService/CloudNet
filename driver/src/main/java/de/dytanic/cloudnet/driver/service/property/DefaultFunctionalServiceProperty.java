...
public class DefaultFunctionalServiceProperty<T> implements ServiceProperty<T> {
  ...
  public static <T> @NotNull DefaultFunctionalServiceProperty<T> create() {
    return new DefaultFunctionalServiceProperty<>();
  }

  public @NotNull DefaultFunctionalServiceProperty<T> reader(@NotNull Function<ServiceInfoSnapshot, T> getFunction) {
    this.getFunction = getFunction;
    return this;
  }

  public @NotNull DefaultFunctionalServiceProperty<T> writer(@NotNull BiConsumer<ServiceInfoSnapshot, T> setConsumer) {
    this.setConsumer = setConsumer;
    return this;
  }

  @Override
  public @NotNull Optional<T> read(@NotNull ServiceInfoSnapshot serviceInfoSnapshot) {
  ...
  @Override
  public void write(@NotNull ServiceInfoSnapshot serviceInfoSnapshot, @Nullable T value) {
