 ...
 * @since 4.0
 */
public final class DocumentSerialisationException extends RuntimeException {

  @Serial
  private static final long serialVersionUID = 7960311498621002589L;
   ...
   */
  public DocumentSerialisationException(@NonNull Throwable cause) {
    super(cause);
  }
   ...
   */
  public DocumentSerialisationException(@NonNull String message, @NonNull Throwable cause) {
    super(message, cause);
  }
}
