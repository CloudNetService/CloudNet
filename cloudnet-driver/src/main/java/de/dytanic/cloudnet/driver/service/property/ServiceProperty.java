...
public interface ServiceProperty<T> {
    ...
    /**
     * Sets a property into the properties of the given {@link ServiceInfoSnapshot}. Some properties might not support this.
     * An update of the service might be necessary.
     *
