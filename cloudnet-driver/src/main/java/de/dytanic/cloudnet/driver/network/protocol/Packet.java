...
/**
 * A packet represents the message format between a INetworkConnector and a INetworkServer instance
 * Every packet has a channel id, from that the IPacketListenerRegistry, can filter
...
public interface Packet {
    ...
    /**
     * Returns the uuid of the packet. Each packet should has a own defined UUID instance, less
     * the callback packets for synchronized messages between client and server
     *
    ...
    /**
     * The header, contain all important information from the packet, to specify the packet type as channel does and/or can
     * has the data, which that are important to handle with
     * <p>
