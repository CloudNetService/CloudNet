...
public abstract class DefaultNetworkChannel implements INetworkChannel {
    ...
    public DefaultNetworkChannel(IPacketListenerRegistry packetRegistry, HostAndPort serverAddress, HostAndPort clientAddress, boolean clientProvidedChannel, INetworkChannelHandler handler) {
    ...
    @Override
    public boolean sendChunkedPackets(@NotNull UUID uniqueId, @NotNull JsonDocument header, @NotNull InputStream inputStream, int channel) throws IOException {
    ...
    @Override
    public boolean sendChunkedPacketsResponse(@NotNull UUID uniqueId, @NotNull JsonDocument header, @NotNull InputStream inputStream) throws IOException {
