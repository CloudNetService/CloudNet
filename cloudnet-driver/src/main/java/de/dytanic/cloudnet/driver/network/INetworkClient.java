...
/**
 * The network client represents a client based connector to one or more remote
 * servers.
 */
public interface INetworkClient extends INetworkComponent, AutoCloseable {
   ...
   * @return true if the connection was success or false if the connection was
   * unsuccessful or refused
   */
