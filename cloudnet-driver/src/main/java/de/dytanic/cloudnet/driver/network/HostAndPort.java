...
/**
 * This class holds a easy IP/Hostname and port configuration for a server or a
 * client bind address
 */
@Getter
@EqualsAndHashCode
...
public class HostAndPort {
  ...
  /**
   * The host address which is configured by the constructors The host string
   * can be a IPv4, IPv6 and a string
   */
