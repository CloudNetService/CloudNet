...
public enum DriverAPIRequestType {
    ...
    // CloudServiceFactory
    CREATE_CUSTOM_CLOUD_SERVICE(DriverAPICategory.CLOUD_SERVICE_FACTORY),
    CREATE_CUSTOM_CLOUD_SERVICE_WITH_NODE_AND_AMOUNT(DriverAPICategory.CLOUD_SERVICE_FACTORY),
    CREATE_CLOUD_SERVICE_BY_SERVICE_TASK(DriverAPICategory.CLOUD_SERVICE_FACTORY),
    CREATE_CLOUD_SERVICE_BY_SERVICE_TASK_AND_ID(DriverAPICategory.CLOUD_SERVICE_FACTORY),
