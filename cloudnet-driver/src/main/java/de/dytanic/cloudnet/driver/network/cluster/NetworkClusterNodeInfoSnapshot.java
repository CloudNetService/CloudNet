...
public class NetworkClusterNodeInfoSnapshot extends SerializableJsonDocPropertyable implements SerializableObject {
    ...
    /**
     * @deprecated Use {@link #NetworkClusterNodeInfoSnapshot(long, long, NetworkClusterNode, String, int, int, int, int, double, ProcessSnapshot, Collection, double)} instead
     */
    @Deprecated
