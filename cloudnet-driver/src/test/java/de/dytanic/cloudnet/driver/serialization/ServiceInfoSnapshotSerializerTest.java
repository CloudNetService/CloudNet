    ...
    public void serializeServiceInfoSnapshot() {
        ServiceInfoSnapshot original = new ServiceInfoSnapshot(
                ...
                new ServiceConfiguration(
                        new ServiceId(UUID.fromString("fdef0011-1c58-40c8-bfef-0bdcb1495938"), "Node-1", "Lobby", 1, ServiceEnvironmentType.MINECRAFT_SERVER),
                        "jvm",
                        true,
                        false,
                        ...
                        new ServiceDeployment[]{new ServiceDeployment(new ServiceTemplate("Backup", "Lobby", "local", true), Arrays.asList("some", "excluded", "files"))},
