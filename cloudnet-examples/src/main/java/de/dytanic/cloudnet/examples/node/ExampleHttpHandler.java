...
public final class ExampleHttpHandler {
  ...
  public void registerHttpHandlerExample() {
    ...
    CloudNet.getInstance().getHttpServer()
        .registerHandler( //Register for the http get specific an http handler
            "/your_name/{name}", //Http
              ...
              public void handleGet(String path, IHttpContext context)
                ...
                context
                    ...
                    .body("Your name is " + context.request().pathParameters()
                        .containsKey(
                            "name")) //get the following path parameter "name"
                    .context()
                    .closeAfter(true)
                    .cancelNext()
                ;
    ...
    CloudNet.getInstance().getHttpServer()
        .removeHandler(ExampleHttpHandler.class.getClassLoader());
  }
}