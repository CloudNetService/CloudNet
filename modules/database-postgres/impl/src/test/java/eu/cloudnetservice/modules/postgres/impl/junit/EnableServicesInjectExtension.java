...
package eu.cloudnetservice.modules.postgres.impl.junit;
...
public final class EnableServicesInjectExtension
  ...
  private void setupInjectionAndServicesState() {
    ...
    bootInjectionLayer.installAutoConfigureBindings(EnableServicesInjectExtension.class.getClassLoader(), "node");
