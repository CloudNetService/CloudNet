...
public final class V2HttpHandlerService extends V2HttpHandler {
  ...
  @BearerAuth
  @HandlerScope({"cloudnet_rest:service_read", "cloudnet_rest:service_list"})
  ...
  @BearerAuth
  @HandlerScope({"cloudnet_rest:service_read", "cloudnet_rest:service_get"})
  ...
  @BearerAuth
  @HandlerScope({"cloudnet_rest:service_write", "cloudnet_rest:service_lifecycle"})
  ...
  @BearerAuth
  @HandlerScope({"cloudnet_rest:service_write", "cloudnet_rest:service_send_commands"})
  ...
  @BearerAuth
  @HandlerScope({"cloudnet_rest:service_write", "cloudnet_rest:service_include"})
  ...
  @BearerAuth
  @HandlerScope({"cloudnet_rest:service_write", "cloudnet_rest:service_deploy_resources"})
  ...
  @BearerAuth
  @HandlerScope({"cloudnet_rest:service_read", "cloudnet_rest:service_log_lines"})
  ...
  @BearerAuth
  @HandlerScope({"cloudnet_rest:service_read", "cloudnet_rest:service_live_log"})
  ...
  @BearerAuth
  @HandlerScope({"cloudnet_rest:service_write", "cloudnet_rest:service_create"})
  ...
  @BearerAuth
  @HandlerScope({"cloudnet_rest:service_write", "cloudnet_rest:service_add_file"})
  ...
  @BearerAuth
  @HandlerScope({"cloudnet_rest:service_write", "cloudnet_rest:service_delete"})
