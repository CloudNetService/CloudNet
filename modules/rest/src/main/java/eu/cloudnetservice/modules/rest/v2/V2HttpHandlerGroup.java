...
public final class V2HttpHandlerGroup extends V2HttpHandler {
  ...
  @BearerAuth
  @HandlerScope({"cloudnet_cloudnet_rest:group_read", "cloudnet_rest:group_list"})
  ...
  @BearerAuth
  @HandlerScope({"cloudnet_rest:group_read", "cloudnet_rest:group_exists"})
  ...
  @BearerAuth
  @HandlerScope({"cloudnet_rest:group_read", "cloudnet_rest:group_get"})
  ...
  @BearerAuth
  @HandlerScope({"cloudnet_rest:group_write", "cloudnet_rest:group_create"})
  ...
  @BearerAuth
  @HandlerScope({"cloudnet_rest:group_write", "cloudnet_rest:group_delete"})
