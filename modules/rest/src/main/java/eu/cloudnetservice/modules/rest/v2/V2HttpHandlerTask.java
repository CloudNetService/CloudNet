...
public final class V2HttpHandlerTask extends V2HttpHandler {
  ...
  @BearerAuth
  @HandlerScope({"rest_task_read", "rest_task_list"})
  ...
  @BearerAuth
  @HandlerScope({"rest_task_read", "rest_task_exists"})
  ...
  @BearerAuth
  @HandlerScope({"rest_task_read", "rest_task_get"})
  ...
  @BearerAuth
  @HandlerScope({"rest_task_write", "rest_task_create"})
  ...
  @BearerAuth
  @HandlerScope({"rest_task_write", "rest_task_delete"})
