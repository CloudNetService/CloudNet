...
public final class V2HttpHandlerCluster extends V2HttpHandler {
  ...
  @BearerAuth
  @HandlerScope({"cloudnet_rest:cluster_read", "cloudnet_rest:cluster_node_list"})
  ...
  @BearerAuth
  @HandlerScope({"cloudnet_rest:cluster_read", "cloudnet_rest:cluster_node_get"})
  ...
  @BearerAuth
  @HandlerScope({"cloudnet_rest:cluster_write", "cloudnet_rest:cluster_node_command"})
  ...
  @BearerAuth
  @HandlerScope({"cloudnet_rest:cluster_write", "cloudnet_rest:cluster_node_create"})
  ...
  @BearerAuth
  @HandlerScope({"cloudnet_rest:cluster_write", "cloudnet_rest:cluster_node_delete"})
  ...
  @BearerAuth
  @HandlerScope({"cloudnet_rest:cluster_write", "cloudnet_rest:cluster_node_update"})
