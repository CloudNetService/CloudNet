...
public final class V2HttpHandlerCluster extends V2HttpHandler {
  ...
  @BearerAuth
  @HandlerScope({"rest:cluster_read", "rest:cluster_node_list"})
  ...
  @BearerAuth
  @HandlerScope({"rest:cluster_read", "rest:cluster_node_get"})
  ...
  @BearerAuth
  @HandlerScope({"rest:cluster_write", "rest:cluster_node_command"})
  ...
  @BearerAuth
  @HandlerScope({"rest:cluster_write", "rest:cluster_node_create"})
  ...
  @BearerAuth
  @HandlerScope({"rest:cluster_write", "rest:cluster_node_delete"})
  ...
  @BearerAuth
  @HandlerScope({"rest:cluster_write", "rest:cluster_node_update"})
