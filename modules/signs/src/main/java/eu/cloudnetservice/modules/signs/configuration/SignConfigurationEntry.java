    ...
    return SignConfigurationEntry.builder()
      ...
      .groupConfigurations(List.of(SignGroupConfiguration.builder()
        ...
        .emptyLayout(SignLayoutsHolder.singleLayout(SignLayout.builder()
          .lines("&%task% &0- &7%task_id%", "&8[&7LOBBY&8]", "%online_players% / %max_players%", "%motd%")
          .blockMaterial(onlineBlockType)
          .build()))
        .onlineLayout(SignLayoutsHolder.singleLayout(SignLayout.builder()
          .lines("&e%task% &0- &e%task_id%", "&8[&eLOBBY&8]", "%online_players% / %max_players%", "%motd%")
          .blockMaterial(onlineBlockType)
          .build()))
        .fullLayout(SignLayoutsHolder.singleLayout(SignLayout.builder()
          .lines("&6%task% &0- &6%task_id%", "&8[&6PRIME&8]", "%online_players% / %max_players%", "%motd%")
      ...
      .emptyLayout(SignLayoutsHolder.singleLayout(SignLayout.builder()
        .lines("&7%task% &0- &7%task_id%", "&8[&7LOBBY&8]", "%online_players% / %max_players%", "%motd%")
        .blockMaterial(onlineBlockType)
        .build()))
      .onlineLayout(SignLayoutsHolder.singleLayout(SignLayout.builder()
        .lines("&e%task% &0- &e%task_id%", "&8[&eLOBBY&8]", "%online_players% / %max_players%", "%motd%")
        ...
        .build()))
      .fullLayout(SignLayoutsHolder.singleLayout(SignLayout.builder()
        .lines("&%task% &0- &6%task_id%", "&8[&6PRIME&8]", "%online_players% / %max_players%", "%motd%")
        .blockMaterial(fullBlockType)
        .build()))
      .build();
  }
