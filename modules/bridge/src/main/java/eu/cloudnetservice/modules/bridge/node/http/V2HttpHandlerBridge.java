...
public final class V2HttpHandlerBridge extends V2HttpHandler {
  ...
  @BearerAuth
  @HandlerScope({"bridge:player_read", "bridge:player_online_count"})
  ...
  @BearerAuth
  @HandlerScope({"bridge:player_read", "bridge:player_registered_count"})
  ...
  @BearerAuth
  @HandlerScope({"bridge:player_read", "bridge:player_exists"})
  ...
  @BearerAuth
  @HandlerScope({"bridge:player_read", "bridge:player_get"})
  ...
  @BearerAuth
  @HandlerScope({"bridge:player_write", "bridge:player_create"})
  ...
  @BearerAuth
  @HandlerScope({"bridge:player_write", "bridge:player_delete"})
